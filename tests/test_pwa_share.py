...
def test_mobile_utilities_are_bootstrapped_same_origin():
    loader = read("scanner-privacy-loader.js")
    assert 'link.href = "pwa-share.css"' in loader
    assert 'script.src = "pwa-share.js"' in loader
    assert "https://cdn.jsdelivr.net/npm/@zxing/browser" in loader  # scanner stays lazy
...
if __name__ == "__main__":
    ...
    test_mobile_utilities_are_bootstrapped_same_origin()
