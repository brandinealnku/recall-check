  ...
  function installSheet() {
    ...
    sheet.innerHTML = `
      <section class="rc-install-panel">
        ...
        <p class="rc-install-note">Apple does not currently allow websites to complete the Home Screen install automatically, so Safari requires these final taps.</p>
