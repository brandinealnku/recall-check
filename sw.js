"use strict";
const CACHE = "recallcheck-static-v0.5-date-checking";
const STATIC = ["./", "./index.html", "./styles.css", "./app.js", "./date-check.js", "./manifest.webmanifest", "./assets/icons/recallcheck.svg", "./data/demo-products.json", "./data/demo-recalls.json"];
