"use strict";
const CACHE = "recallcheck-static-v0.6-recall-focused";
const STATIC = ["./", "./index.html", "./styles.css", "./app.js", "./manifest.webmanifest", "./assets/icons/recallcheck.svg", "./data/demo-products.json", "./data/demo-recalls.json"];
